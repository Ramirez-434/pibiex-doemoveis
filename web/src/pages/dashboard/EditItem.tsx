    ...
    return (
        <div className="w-full px-3 sm:px-4 md:px-0 animate-fade-in-up">
            <div className="mb-6 sm:mb-8">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">Editar Anúncio</h1>
                <p className="text-sm sm:text-base text-gray-500">Altere as informações do item que deseja doar.</p>
            </div>
