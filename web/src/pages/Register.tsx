...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4 font-sans">
            <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse animate-scale-in">
                {/* Right Side - Image/Branding */}
                <div className="md:w-5/12 bg-secondary p-12 text-white flex flex-col justify-between relative overflow-hidden">
                ...
                {/* Left Side - Form */}
                <div className="md:w-7/12 p-8 md:p-12 overflow-y-auto max-h-[90vh] bg-white relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="group">
                                    ...
                                    <div className="relative transition-all duration-300 focus-within:transform focus-within:-translate-y-1">
                                        <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-secondary transition-colors" size={20} />
                                        <input
                                            type="text"
                                            name="phone"
